    ...
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <div className="p-4 border-t border-white/10 bg-black flex-shrink-0">
          ...
          {/* AdminLayout is admin / super_admin / judge only —
              `club_captain` lands on `TeamPanelLayout` (see
              `routes.tsx`), so no NotificationBell is mounted here.
              The bell lives in TeamPanelLayout next to its own
