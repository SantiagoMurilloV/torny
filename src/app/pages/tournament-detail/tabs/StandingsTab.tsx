...
function CategoryStandingsTable({
  ...
  return (
    ...
    >
      {/* Inner scroller: forces a comfortable minimum width on mobile so
          font-size + padding can grow without the columns squishing.
          Anything wider than the viewport scrolls horizontally. */}
      <div className="overflow-x-auto max-h-[75vh] overflow-y-auto">
        <table className="w-full min-w-[640px] sm:min-w-0 sm:table-fixed">
          <thead
            className="sticky top-0 z-10 bg-black text-white"
            style={{ ...FONT, letterSpacing: '0.06em' }}
          >
            <tr className="text-[11px] sm:text-xs uppercase">
              <th className="px-2 sm:px-3 py-2.5 sm:py-3 text-left font-bold w-9 sm:w-12">#</th>
              <th className="px-2 sm:px-3 py-2.5 sm:py-3 text-left font-bold">Equipo</th>
              <th
                className="px-1.5 sm:px-2 py-2.5 sm:py-3 text-center font-bold w-12 sm:w-14"
                title="Grupo"
              >
                Grp
              </th>
              <th
                className="px-1 sm:px-2 py-2.5 sm:py-3 text-right font-bold w-9 sm:w-10"
              ...
              <th
                className="px-1 sm:px-2 py-2.5 sm:py-3 text-right font-bold w-14 sm:w-16"
                title="Sets ganados / perdidos"
              >
                Sets
              </th>
              <th
                className="px-1 sm:px-2 py-2.5 sm:py-3 text-right font-bold w-16 sm:w-20"
                title="Puntos a favor / en contra sumados en todos los sets"
              >
                Pts
              </th>
              <th
                className="px-2 sm:px-3 py-2.5 sm:py-3 text-right font-bold w-10 sm:w-14"
                ...
                >
                  ...
                  <td className="px-2 sm:px-3 py-2 sm:py-2.5">
                    <div className="flex items-center gap-2 min-w-0">
                      ...
                      <span
                        className="font-bold text-xs sm:text-sm uppercase truncate min-w-0"
                  ...
                  <td className="px-1.5 sm:px-2 py-2 sm:py-2.5 text-center">
                    <span
                      className="inline-flex items-center justify-center min-w-[28px] px-1.5 h-6 rounded-sm bg-black/5 text-[11px] sm:text-xs font-bold text-black/70 tabular-nums"
                      style={FONT}
                  ...
                  <td className="px-1 sm:px-2 py-2 sm:py-2.5 text-right text-xs sm:text-sm tabular-nums text-black/70">
                    {row.played}
                  </td>
                  <td
                    className="px-1 sm:px-2 py-2 sm:py-2.5 text-right text-xs sm:text-sm font-bold tabular-nums"
                    style={{ color: 'var(--feedback-win)' }}
                  >
                    {row.wins}
                  </td>
                  <td className="px-1 sm:px-2 py-2 sm:py-2.5 text-right text-xs sm:text-sm tabular-nums text-black/50">
                    {row.losses}
                  </td>
                  <td className="px-1 sm:px-2 py-2 sm:py-2.5 text-right text-[11px] sm:text-xs tabular-nums text-black/60">
                    {row.setsFor}/{row.setsAgainst}
                  </td>
                  <td
                    className="px-1 sm:px-2 py-2 sm:py-2.5 text-right text-[11px] sm:text-xs tabular-nums text-black/60"
                    title="Puntos a favor / en contra en todos los sets"
                  >
                    {row.pointsFor}/{row.pointsAgainst}
                  </td>
                  <td
                    className="px-2 sm:px-3 py-2 sm:py-2.5 text-right font-bold text-base sm:text-xl tabular-nums"
